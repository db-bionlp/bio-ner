...
def main(args):
    ...
    trainer = Trainer(args,dev_dataset=dev_dataset,train_dataset=train_dataset,test_dataset=test_dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--filename", default='../ddi_dataset/NCBI-disease', type=str, help="train file name")

    parser.add_argument("--data_dir",  default='../ddi_dataset/NCBI-disease', type=str, help="The input data dir. Should contain the .tsv files (or other data files) for the task.")

    parser.add_argument("--label_file",  default='../ddi_dataset/NCBI-disease/labels.txt', type=str, help="Label file")

    parser.add_argument("--model_dir",  default='../saved_model/bert_model/epoch_1', type=str, help="Path to model")

    parser.add_argument("--model_type",  default='bert', type=str,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))

    parser.add_argument("--model",   default='only_bert', type=str,  help="which model to use: only_bert , bert_center,character_bert_center")

    parser.add_argument("--do_train", default=True,  help="whether do train.")

    parser.add_argument("--do_eval", default=True,  help="whether do dev.")
